...
public class Leaderboard : MonoBehaviour
{
    ...
    public static IEnumerator GetLeaderBoard(string matchingScheme, string numShapes)
    {
        //get data
        string url = "https://stat2games.sites.grinnell.edu/php/getshapesplosionleaderboard.php?scheme=" + matchingScheme +"&numshapes=" + numShapes;
