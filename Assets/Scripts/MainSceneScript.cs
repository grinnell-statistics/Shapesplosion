...
public class MainSceneScript : MonoBehaviour
{
    ...
    public void PlayGame()
    {
        ...
        else if (groupSet && playerSet && (!IsBadWord(playerAlias.text)) && (!IsBadWord(groupID.text)))
        {
            ...
            Debug.Log("text is main" + playerAlias.text);
            Debug.Log("text is main playerAlias" + PlayerData.playerAliasStr);
    ...
    public void PlayTutorial()
    {
        ...
        string Url = "https://www.youtube.com/watch?v=R9Vwk8RivtI&feature=youtu.be&fbclid=IwAR0ItDng_r6Sadb5Rn3m-Bx_bG3mUSW4FY97riFQnKffSl4aAdCjjjWFgEk";
        #if !UNITY_EDITOR
            OpenWindow(Url);
        #endif
        #if UNITY_EDITOR
    ...
    public void PlayResources()
    {
        ...
        string Url = "https://stat2labs.sites.grinnell.edu/shapesplosion.html";
        #if !UNITY_EDITOR
            OpenWindow(Url);
        #endif
        #if UNITY_EDITOR
